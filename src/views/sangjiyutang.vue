                ...
                <div class="">
                    <main class="card">
                        <div class="gallery-container" ref="container1" @mousedown="(e) => startDrag(e, 1)"
                            @touchstart.passive="(e) => startDrag(e, 1)" @mousemove="(e) => handleDrag(e, 1)" @touchmove="(e) => handleDrag(e, 1)"
                            @mouseup="(e) => endDrag(e, 1)" @mouseleave="(e) => endDrag(e, 1)" @touchend="(e) => endDrag(e, 1)">
                            <div class="gallery-track" ref="track1" :style="{ transform: `translateX(${position1}px)` }">
                ...
                <div class="">
                    <main class="card">
                        <div class="gallery-container" ref="container2" @mousedown="(e) => startDrag(e, 2)"
                            @touchstart.passive="(e) => startDrag(e, 2)" @mousemove="(e) => handleDrag(e, 2)" @touchmove="(e) => handleDrag(e, 2)"
                            @mouseup="(e) => endDrag(e, 2)" @mouseleave="(e) => endDrag(e, 2)" @touchend="(e) => endDrag(e, 2)">
                            <div class="gallery-track" ref="track2" :style="{ transform: `translateX(${position2}px)` }">
                ...
                <div class="">
                    <main class="card">
                        <div class="gallery-container" ref="container3" @mousedown="(e) => startDrag(e, 3)"
                            @touchstart.passive="(e) => startDrag(e, 3)" @mousemove="(e) => handleDrag(e, 3)" @touchmove="(e) => handleDrag(e, 3)"
                            @mouseup="(e) => endDrag(e, 3)" @mouseleave="(e) => endDrag(e, 3)" @touchend="(e) => endDrag(e, 3)">
                            <div class="gallery-track" ref="track3" :style="{ transform: `translateX(${position3}px)` }">
                ...
                <div class="">
                    <main class="card">
                        <div class="gallery-container" ref="container4" @mousedown="(e) => startDrag(e, 4)"
                            @touchstart.passive="(e) => startDrag(e, 4)" @mousemove="(e) => handleDrag(e, 4)" @touchmove="(e) => handleDrag(e, 4)"
                            @mouseup="(e) => endDrag(e, 4)" @mouseleave="(e) => endDrag(e, 4)" @touchend="(e) => endDrag(e, 4)">
                            <div class="gallery-track" ref="track4" :style="{ transform: `translateX(${position4}px)` }">
                ...
                <div class="">
                    <main class="card">
                        <div class="gallery-container" ref="container5" @mousedown="(e) => startDrag(e, 5)"
                            @touchstart.passive="(e) => startDrag(e, 5)" @mousemove="(e) => handleDrag(e, 5)" @touchmove="(e) => handleDrag(e, 5)"
                            @mouseup="(e) => endDrag(e, 5)" @mouseleave="(e) => endDrag(e, 5)" @touchend="(e) => endDrag(e, 5)">
                            <div class="gallery-track" ref="track5" :style="{ transform: `translateX(${position5}px)` }">
...
import * as images from '@/assets/image.js'
